...
mod tests {
    ...
    fn test_new_minimal_valid() {
        ...
        let actual_app_def_version: u32 = appmgr.get(0).general.zusearch_app_definition_version;
        assert_eq!(
    ...
    fn test_new_minimal_invalid() {
        ...
        let expected = "Invalid App definition. Error in Yaml file: missing field `general` at line 1 column 8".to_string();
